...
INSERT INTO Alumnos (Nombre)    VALUES ('Romina Quispe'), ('Maria Mamani'), ('Luis Sanchez'), ('Miranda Lopez'), ('Jorge Salazar');
...
SELECT * FROM Matriculas;
 ...
 --INNER JOIN solo alumnos con matricula
SELECT 
    a.Nombre AS Alumno,
    c.Nombre AS Curso,
...
--LEFT JOIN todos los alumnos con matricula o sin matricula
